...
with [Using Go Modules](https://docs.studygolang.com/blog/using-go-modules).
...
and Beyond](https://docs.studygolang.com/blog/v2-go-modules) for a more detailed example.
